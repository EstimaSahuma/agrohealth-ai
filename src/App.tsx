...
import './App.css'
import type { MediaItem, PlantAnalysis } from './types';
              ...
              <div className="bg-white p-6 sm:p-10 rounded-3xl shadow-xl border border-gray-100">
                ...
                <div className="mt-8">
                  <button
                    ...
                    className={`w-full py-5 px-6 rounded-2xl font-bold text-xl shadow-lg transition-all transform active:scale-[0.98] flex items-center justify-center gap-3 ${isAnalyzing || mediaItems.length === 0
